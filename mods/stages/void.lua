...
function onCreate() 
	...
	makeAnimatedLuaSprite('blackjack', 'characters/spooky_kids_assets', 4842.55, 4642.55);
	bjDefY = getProperty('blackjack.y')
	addAnimationByPrefix('blackjack', 'dance', 'spooky dance idle', 30, true);
	addAnimationByPrefix('blackjack', 'die', 'spooky sing right', 30, false);
	setProperty('blackjack.flipX', true)
