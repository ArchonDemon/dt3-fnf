--Dual characters 1.0 alpha by HEAVYSTYLES aka VECTOR
    ...
    local charid = "lyrix" --it doesn´t matter what you put in here, it just has to be different than any other charid of the scripts in the folder
   ...
   local char = "satan-m" --use the image name from image/characters


   local charpath ="characters/" -- in case you want to use another path


   local charorder = 100 --setObjectOrder(charid,charorder)
   ...
   local notename = "Satan" --what notetype will the character sing
   ...
   local leftoffset = {28,-1} --x,y

   local downoffset = {-17,-25}

   local upoffset = {-23,11}

   local rightoffset = {-27,-1}
