--Dual characters 1.0 alpha by HEAVYSTYLES aka VECTOR
    ...
    local charid = "green" --it doesn´t matter what you put in here, it just has to be different than any other charid of the scripts in the folder
   ...
   local char = "green-m-nt" --use the image name from image/characters
   ...
   local notename = "Gren" --what notetype will the character sing
   ...
   local leftoffset = {1,-3} --x,y

   local downoffset = {-10,-60}

   local upoffset = {-38,7}

   local rightoffset = {17,0}
