--Dual characters 1.0 alpha by HEAVYSTYLES aka VECTOR
    ...
    local charid = "electra" --it doesn´t matter what you put in here, it just has to be different than any other charid of the scripts in the folder
   ...
   local char = "electra-m-nt" --use the image name from image/characters


   local charpath ="characters/" -- in case you want to use another path


   local charorder = 10 --setObjectOrder(charid,charorder)
   ...
   local notename = "Electra" --what notetype will the character sing
   ...
   local leftoffset = {56,-7} --x,y

   local downoffset = {10,-35}

   local upoffset = {-22,23}

   local rightoffset = {-48,12}
