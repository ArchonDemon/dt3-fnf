--Dual characters 1.0 alpha by HEAVYSTYLES aka VECTOR
    ...
    local charid = "reaper" --it doesn´t matter what you put in here, it just has to be different than any other charid of the scripts in the folder
   ...
   local char = "reaper-m-nt" --use the image name from image/characters


   local charpath ="characters/" -- in case you want to use another path


   local charorder = 12 --setObjectOrder(charid,charorder)
   ...
   local notename = "Reaper" --what notetype will the character sing
   ...
   local leftoffset = {102,-13} --x,y

   local downoffset = {68,-46}

   local upoffset = {-35,19}

   local rightoffset = {79,0}
