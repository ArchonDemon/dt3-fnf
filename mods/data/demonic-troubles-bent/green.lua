--Dual characters 1.0 alpha by HEAVYSTYLES aka VECTOR
    ...
    local charid = "2" --it doesn´t matter what you put in here, it just has to be different than any other charid of the scripts in the folder
   ...
   local charorder = 5 --setObjectOrder(charid,charorder)
